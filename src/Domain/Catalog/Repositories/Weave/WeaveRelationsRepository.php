...
final class WeaveRelationsRepository extends AbstractRelationsRepository
{
    ...
    public function indexRelations(array $data): Paginator|Model
    {
        ...
        if (in_array(Weave::findOrFail($id)->{$relation}()::class, config('api-settings.to-one')))
        {
    ...
    public function updateRelations(array $data): void
    {
         ...
         */
            ...
            data_get($data, 'model') ?? data_set($data, 'model', Weave::findOrFail(data_get($data, 'id')));
