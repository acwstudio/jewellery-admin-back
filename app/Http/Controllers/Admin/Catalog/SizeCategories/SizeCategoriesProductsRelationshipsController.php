...
class SizeCategoriesProductsRelationshipsController extends Controller
{
    ...
    public function index(Request $request, int $id): JsonResponse
    {
        ...
        $paginatedQuery = $this->sizeCategoryRelationsService->indexSizeCategoriesProducts($data);
