...
use App\Modules\Delivery\Models\IpLog;
use App\Modules\Delivery\Policies\DeliveryPolicy;
use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Str;

/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Modules\Delivery\Models\IpLog>
 */
class IpLogFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'naselenniy_punkt' => $this->faker->city(),
            ...
            'delivery_days' => DeliveryPolicy::DEFAULT_DELIVERY_TIME
        ];
    }
}
